...
def validate(metadata: dict) -> tuple:
    ...
    if (
        metadata_content['subject'] and
        metadata_content['subject']['date_of_birth'] and
        type(metadata_content['subject']['date_of_birth']) is datetime.datetime
    ):
        metadata_content['subject']['date_of_birth'] = metadata_content['subject']['date_of_birth'].utcnow().isoformat()
