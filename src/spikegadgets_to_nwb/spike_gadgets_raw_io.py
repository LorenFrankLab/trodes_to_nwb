...
from neo.rawio.baserawio import (BaseRawIO, _signal_channel_dtype, _signal_stream_dtype,
    _spike_channel_dtype, _event_channel_dtype)  # TODO the import location was updated for this notebook
...
class SpikeGadgetsRawIO(BaseRawIO):
    ...
    def _parse_header(self):
        ...
        packet_size += 4
        assert "sysTimeIncluded" not in hconf.attrib, "sysTimeIncluded not supported yet"
    ...
    def get_analogsignal_timestamps(self, i_start, i_stop):
        raw_uint8 = self._raw_memmap[i_start:i_stop, self._timestamp_byte:self._timestamp_byte + 4]
